...
const BRAND = {
  ...
  weibo: {
    color: '#E6162D',
    svg: (
      <svg width="14" height="14" viewBox="0 0 24 24" fill="#E6162D" aria-hidden="true">
        <path d="M10.098 20c-4.612-.02-8.28-2.27-8.164-5.019.12-2.779 3.981-4.967 8.614-4.862 4.633.105 8.22 2.469 8.112 5.278-.11 2.808-4.025 4.624-8.562 4.603zm-.175-7.87c-2.76-.145-4.94 1.166-4.872 2.94.069 1.776 2.37 3.133 5.138 3.054 2.768-.078 4.946-1.565 4.876-3.338-.069-1.774-2.382-3.51-5.142-3.656zm.857 2.26c-.637-.189-1.36.11-1.618.668a1.21 1.21 0 0 0 .765 1.62c.636.197 1.367-.11 1.626-.681.258-.569-.136-1.408-.773-1.606zm-1.71 2.258c-.228.048-.458-.053-.512-.226-.055-.174.09-.355.318-.403.227-.048.457.052.511.226.055.174-.09.355-.317.403zm1.103-.748c-.078.183-.31.264-.52.18-.212-.082-.315-.302-.238-.485.079-.183.31-.264.52-.18.21.083.314.303.238.485zM21.982 7.94c-1.025-3.012-5.162-5.153-9.235-4.761-4.073.391-6.454 3.282-5.428 6.294.21.623.034.847-.404.851-.618.005-1.398-.524-1.98-.853-.578-.329-1.033-.23-.8.44.45 1.308 1.688 2.323 3.037 2.805.524.186.74.433.57.817-.104.238-.378.44-.631.596-.256.158-.296.388-.068.497a6.565 6.565 0 0 0 2.803.6c2.107 0 4.17-.89 5.614-2.409 1.444-1.519 2.186-3.589 1.73-5.469-.174-.717.145-.936.776-.685.795.316 1.568.848 2.016 1.477z" />
      </svg>
    ),
  },
  youtube: {
